...
%% input data
f_num  = input('Please choose the number of example functions (f1-f6): ','s');
% no. of input Fourier modes is n+1
n      = input('Please type the number of points for the test function (even integer >1): '); 
%no. of seperate intevals
r      = input('Please type the number of subintervals (integer >1): '); 
